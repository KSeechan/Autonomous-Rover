...
void loop() {
  ...
  //search for a delivery zone and deliver the block.
  if (state2 == true) {
    state1 = false;
    obstacle_avoid();
...
//This function turns the rover 90 degs to the right by setting left motor forward and right motor backward.
